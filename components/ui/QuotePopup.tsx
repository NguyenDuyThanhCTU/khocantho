...
import { MapPin, X, ArrowRight, Truck, Map } from "lucide-react";
              ...
              <div className="relative z-10 p-8 pt-10">
                ...
                <div className="w-16 h-16 bg-orange-100 rounded-2xl flex items-center justify-center mb-6 mx-auto relative">
                  <motion.div
                    ...
                    className="absolute inset-0 bg-brand-orange/20 rounded-2xl"
                  />
                  <MapPin className="w-8 h-8 text-brand-orange relative z-10" />
                </div>
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-slate-600 leading-relaxed text-sm">
                    An Tâm Express hỗ trợ{" "}
                    <strong className="text-brand-orange">
                      lấy hàng tận nhà miễn phí
                    </strong>{" "}
                    khu vực Miền Tây. Hãy chọn kho gần bạn nhất để nhận báo giá
                    ưu đãi và được phục vụ nhanh chóng.
                  </p>
                </div>
